...
<div class="container-fluid">
  ...
  <form:form action="/dtpro/admin/saveProduct" modelAttribute="pro" enctype="multipart/form-data">
    ...
    <div id="menu1" class="tab-pane fade">
      <div class="container">
  <form:form action="/dtpro/admin/saveCategory" modelAttribute="cat">
    <div class="form-group">
  ...
  <form:form action="/dtpro/admin/saveSupplier" modelAttribute="sup">
    <div class="form-group">
